...
class MenuViewPlayer(MenuView):
    ...
    def modify_player(cls):
        ...
        if param == "name":
            new_value = cls.check_str_input("Enter the name of the user: ")
        elif param == "lastname":
            new_value = cls.check_str_input("Enter the lastname of the user: ")
        elif param == "birthday":
            new_value = cls.check_birthday_input(
                "Enter the birthday of the user (format: dd/mm/yyyy): "
            )
        elif param == "sex":
            new_value = cls.check_sex_input("Enter the sex of the user: ")
        elif param == "classment":
            new_value = cls.check_int_input("Enter the classment of the user: ")
